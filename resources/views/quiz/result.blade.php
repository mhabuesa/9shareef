      ...
      <div class="content-wrapper">
        ...
        <div class="col-12">
            ...
            <div class="user-profile-header-banner">
                <img src="{{asset('uploads/')}}/pic/9_shareef_cover_photo.jpg" alt="Banner image" class="rounded-top">
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($quizers as $quizer )
                                <tr style="font-weight: 500">
                                    ...
                                    <td> {{$quizer->address}}</td>
                                    <td class="text-center">
                                        <a href="{{route('certificate',$quizer->id)}}"><i class="fa-solid fa-download fa-xl"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
