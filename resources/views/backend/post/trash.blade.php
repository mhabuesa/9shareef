                                        ...
                                        <td class="text-center">
                                            <div class="d-flex">
                                                <button type="button" class="border-0 btn btn-sm"
                                                    onclick="restorepost(this)" data-id="{{ $post->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Restore post"><i
                                                        class="fa fa-undo text-success fa-xl"></i></button>

                                                <button type="button" class="border-0 btn btn-sm"
                                                    onclick="deletepost(this)" data-id="{{ $post->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Permanently Delete"><i
    ...
    <script>
        function restorepost(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('admin.posts.restore', ':id') }}";
        ...
        function deletepost(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('admin.posts.permanentlydelete', ':id') }}";
                    url = url.replace(':id', id);
                    let token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
